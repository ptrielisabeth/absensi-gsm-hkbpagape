...
// PAKSA ZONA WAKTU KE INDONESIA (WIB) AGAR HARI SABTU TERDETEKSI BENAR
...
$hari_ini = date('Y-m-d');
$hari_angka = date('w'); // 0=Minggu, 3=Rabu, 6=Sabtu

// LOGIKA TESTING: Buka untuk Sabtu (6), Minggu (0), dan Rabu (3)
$is_jadwal = ($hari_angka == 6 || $hari_angka == 0 || $hari_angka == 3);

// Penamaan hari untuk tampilan judul
if ($hari_angka == 6 || $hari_angka == 0) {
    $nama_hari = ($hari_angka == 6) ? "Sabtu (Mode Test Minggu)" : "Minggu (Ibadah & Ceria)";
} elseif ($hari_angka == 3) {
    $nama_hari = "Rabu (Sermon)";
} else {
    $nama_hari = "Bukan Jadwal";
}
?>
...
<div class="container">
    ...
    <?php if (!$is_jadwal): ?>
        <div class="form-card text-center py-5">
            ...
            <p class="text-muted small px-3">Hanya tersedia pada hari <b>Sabtu, Minggu</b> dan <b>Rabu</b>.</p>
        ...
        <div class="form-card">
            ...
            <form id="absenForm">
                ...
                <div class="status-options">
                    <?php if ($hari_angka == 6 || $hari_angka == 0): // Pilihan untuk Sabtu & Minggu ?>
                    ...
                    <?php elseif ($hari_angka == 3): // Pilihan untuk Rabu ?>
