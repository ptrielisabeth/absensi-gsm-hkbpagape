...
// Tetap gunakan zona waktu Jakarta agar sinkron dengan waktu di Batam
...
// KEMBALIKAN KE JADWAL ASLI: Hanya Minggu (0) dan Rabu (3)
$is_jadwal = ($hari_angka == 0 || $hari_angka == 3);

// Penamaan hari untuk tampilan
if ($hari_angka == 0) {
    $nama_hari = "Minggu (Ibadah & Ceria)";
} elseif ($hari_angka == 3) {
...
<div class="container">
    ...
    <?php if (!$is_jadwal): ?>
        <div class="form-card text-center py-5">
            ...
            <p class="text-muted small px-3">Hanya tersedia pada hari <b>Minggu</b> dan <b>Rabu</b>.</p>
        ...
        <div class="form-card">
            ...
            <form id="absenForm">
                ...
                <div class="status-options">
                    <?php if ($hari_angka == 0): // Hanya muncul di hari Minggu ?>
                    ...
                    <?php elseif ($hari_angka == 3): // Hanya muncul di hari Rabu ?>
